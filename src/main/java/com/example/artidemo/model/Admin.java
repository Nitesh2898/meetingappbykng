...
public class Admin implements java.io.Serializable{
	...
	public Admin(Long id, String firstname, String lastname, String designation, String department) {
		this.id = id;
	...
	public Admin(String firstname, String lastname, String designation, String department) {
		this.firstname = firstname;
		this.lastname = lastname;
		this.designation = designation;
		this.department = department;
